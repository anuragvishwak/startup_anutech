  ...
  return (
    <div className="App">
      ...
      <div>
        <div className="my-36">
          <div>
            <p className="text-center font-semibold text-8xl text-[#333333]">
              Build Smarter Tools
            </p>
            <p className="text-[#fad02c] text-center font-semibold text-8xl">
              for Smarter People
            </p>
          </div>
          <div className="flex justify-center">
            <p className="text-center text-[#333333] my-10 text-lg w-8/12">
          ...
          <div className="flex items-center justify-center space-x-5">
            ...
            <button className="py-1 px-5 rounded bg-[#fad02c] text-[#333333] shadow font-semibold">
              Book a Demo
            </button>
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center space-x-2 justify-center">
            <p className="text-4xl font-semibold text-[#fad02c]">Our</p>
            <p className="text-4xl font-semibold text-[#333333]">Products</p>
          </div>

          <div className="grid grid-cols-3 gap-10 py-10 px-20">
            <div
              className="text-start shadow border border-gray-300 rounded-xl p-5
                "
            >
              <img src={img1} className="h-60" />
        ...
        <div className="my-20">
          <div className="flex items-center space-x-2 justify-center">
            <p className="text-4xl font-semibold  text-[#333333] ">How we</p>
            <p className="text-4xl font-semibold text-[#fad02c]">
              build our Products
            </p>
          </div>

          <div className="grid grid-cols-4 gap-20 py-10 px-20">
            <div>
            ...
            <div>
              <p className="text-2xl font-semibold">Code / Test</p>
              <p className="text-center">
            ...
            <div>
              <p className="text-2xl font-semibold">Deploy</p>
              <p className="text-center">
        ...
        <div className="my-20 mx-10">
          <div className="flex items-center space-x-2 mb-10 justify-center">
            <p className="text-4xl font-semibold text-[#fad02c]">Build with</p>
          ...
          <div className="flex items-center justify-center w-full">
            <div className="grid grid-cols-4 gap-10 justify-items-center">
              <img className="h-32" src={firebaseLogo} />
              <img className="h-32" src={githubLogo} />
              <img className="h-32" src={vercelLogo} />
              <img className="h-32" src={reactogo} />
              <img className="h-32" src={postmanLogo} />
              <img className="h-32" src={vscode} />
              <img className="h-40" src={tailwindLogo} />
              <img className="h-36" src={figmalogo} />
            </div>
          </div>
        </div>
        ...
        <div className="my-20 mx-10">
          <div className="flex items-center space-x-2 justify-center">
            ...
            <p className="text-4xl font-semibold text-[#fad02c]">FAQs</p>
          </div>
