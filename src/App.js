      ...
      <div>
        ...
        <div>
          <div className="flex items-center space-x-2 justify-center">
            <p className="text-xl sm:text-4xl font-semibold text-[#fad02c]">Our</p>
            <p className="text-xl sm:text-4xl font-semibold text-[#333333]">Products</p>
          </div>
        ...
        <div className="my-10 sm:my-20">
          <div className="flex items-center space-x-2 justify-center">
            <p className="text-xl sm:text-4xl font-semibold  text-[#333333] ">How we</p>
        ...
        <div className="my-10 sm:my-20 mx-5 sm:mx-10">
          <div className="flex items-center space-x-2 mb-10 justify-center">
            <p className="text-xl sm:text-4xl font-semibold text-[#fad02c]">Build with</p>
        ...
        <div className="my-10 sm:my-20  sm:mx-10">
          <div className="flex items-center space-x-2 justify-center">
            ...
            <p className="text-xl sm:text-4xl font-semibold text-[#fad02c]">FAQs</p>
          </div>
